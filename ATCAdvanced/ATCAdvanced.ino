 ...
 * V26AD Parsic Italia SPI IO expander
...
void setup() {   
  ...
  Serial.println("<TtoS01: Bienvenido a arduino total control");
} 
...
void loop() { 
  ...
  if(Prescaler++ > 500){ 
    ...
    //Serial.println("<TtoS01:El valor de la muestra es:" + sSample); 
...
void ParsicInit(){
  ...
  SPI.setBitOrder(MSBFIRST);           // most significative bit first
}

void ParsicDigitalWrite(){
}

void ParsicAnalogWrite(){
}

boolean ParsicDigitalRead(){
}

int ParsicAnalogRead(){
}
